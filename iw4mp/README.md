# MW2 2009 Known Active RCE Mitigations

These are all the documented RCE mitigations for MW2 2009. This repository only includes mitigations for RCE exploits that are currently active on the game.
